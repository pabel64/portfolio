...
window.PORTFOLIO = {
  ...
  /* Home-page headline numbers. Keep these to things you can defend
     in an interview — every one below is countable in the repos. */
  stats: [
    { n: "4",   label: "Production systems" },
    { n: "60",  label: "Agents orchestrated" },
  ...
  projects: [
    {
      ...
      year: "2026",
      summary: "A portable overlay that turns any codebase into a governed, 60-agent software delivery pipeline — with four mandatory human approval gates, artifact verification that agents cannot fake, and an adversarial critic that blocks work for being merely correct.",
      facts: [
        { k: "Agents", v: "60 specialists" },
    ...
    },
    {
      ...
      year: "2026",
      summary: "A field-operations planning system that divides branch-level microfinance targets down to individual staff using a weighted largest-remainder cascade — deterministic enough that a re-run of the same inputs reproduces the same 17,962 numbers, exactly.",
      facts: [
    ...
    },
    {
      ...
      year: "2026",
      summary: "A crawler-to-classroom pipeline: it scrapes editorial and geopolitics sources nightly, scores each article 0–100 for exam relevance through a deterministic taxonomy plus an LLM gate, and serves what survives through an 18-page study workspace. Runs entirely on free-tier and local models by default.",
      facts: [
    ...
    },
    {
      ...
      year: "2026",
      summary: "A role-aware operations dashboard for a five-tier field hierarchy. Field staff see only their own figures; each management tier sees one level wider — and the reporting suite on top of it produces the annual scorecards, transfer analytics and HR exports that used to be assembled by hand.",
      facts: [
    ...
    },
    {
      ...
      year: "2016",
      summary: "A small SCSS mixin that generates sprite-sheet background positioning from a single declaration. Kept here because it is public, readable in one sitting, and shows the habit predates the current work.",
      facts: [
        { k: "Language", v: "SCSS" },
